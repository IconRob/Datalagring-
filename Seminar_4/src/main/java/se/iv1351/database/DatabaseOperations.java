...
public class DatabaseOperations {
    ...
    /**
     * Retrieves a list of all active rentals. This method joins the rental and instrument_booking
     * tables to extract information about currently active instrument rentals.
     *
